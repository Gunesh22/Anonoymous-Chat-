...
class SplashNewAccountFragment : Fragment() {
    private lateinit var binding: FragmentSplashNewAccountBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSplashNewAccountBinding.inflate(inflater, container, false)
        return binding.root
    }
